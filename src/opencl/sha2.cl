...
Generated by:
	(
		...
		echo "// File: src/opencl_sha2_ctx.h"
		curl -sS --location https://github.com/magnumripper/JohnTheRipper/raw/bleeding-jumbo/src/opencl_sha2_ctx.h
	) | grep -v '#include "' > src/opencl/sha2.cl
*/
